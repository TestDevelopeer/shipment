...
<body>
					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box d-sm-flex align-items-center justify-content-between">
								<h4 class="mb-sm-0 font-size-18">Заказ №{$form['form_id']}</h4>

								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										<li class="breadcrumb-item"><a href="/shipment/panel/">Заказы</a></li>
										<li class="breadcrumb-item active">Заказ №{$form['form_id']}</li>
									</ol>
								</div>
									...
									<div class="invoice-title">
										<div class="d-flex align-items-start">
											<div class="flex-grow-1">
												<div class="mb-4">
													<img src="{$templateAdminPath}assets/images/logo-sm.svg" alt=""
														height="24"><span class="logo-txt">{$form['name_sender']}</span>
												</div>
											</div>
										...
										<p class="mb-1"><i class="mdi mdi-email align-middle me-1"></i>
											{$form['email_sender']}</p>
										<p><i class="mdi mdi-phone align-middle me-1"></i> {$form['phone_sender']}</p>
										<p class="mb-1"><b>ИНН:</b> {$form['inn_sender']}</p>
									</div>
									<hr class="my-4">
									<div class="row">
										<div class="col-sm-6">
											<div>
												...
												<h5 class="font-size-14 mb-2">{$form['name_recipient']}</h5>
												<p><i class="mdi mdi-phone align-middle me-1"></i>
													{$form['phone_recipient']}</p>
												<p class="mb-1"><b>ИНН:</b> {$form['inn_recipient']}</p>
										...
										<div class="col-sm-6">
											<div>
												<div>
													...
													<p>Отправление: {$form['point_departure']}</p>
													<p>Получение: {$form['point_destination']}</p>
												</div>
												...
												<div class="mt-4">
													...
													<p>Вес: {$form['weight']}</p>
													<p>Высота: {$form['height']}</p>
													<p>Ширина: {$form['width']}</p>
													<p>Длина: {$form['length']}</p>
												</div>
											</div>
										</div>
										<div class="col-12">
												...
												<div>
													...
													<div class="mb-3">
														<input class="form-control" type="text"
															...
															value="{$form['form_status']}" id="status_text"
															data-form="{$form['form_id']}">
													</div>
													<button type="button"
									...
									<div class="p-4 border rounded">
										<div class="mb-3">
											...
											<select class="form-select" id="select_ship">
												...
												{foreach $shipmentOptions as $ship name = ship}
												<option {if $form['shipment_options']==$ship['option_id']}selected{/if}
													value="{$ship['option_id']}">
													{$ship['option_name']} |
													{$ship['option_regnumber']}</option>
												{/foreach}
											</select>
										</div>
									</div>
									{if $form['shipment_options'] != 0}
									<div class="p-4 border rounded">
										<div class="table-responsive">
											<table class="table table-nowrap align-middle mb-0">
												...
												<tbody id="shipment_option">
													<tr>
														<th scope="row">{$formShip['option_id']}</th>
														<td>
															{$formShip['option_regnumber']}
														</td>
														<td>
															{$formShip['option_name']}
														</td>
														<td>
															{$formShip['option_type']}
														</td>
														<td>
															{$formShip['option_year']}
														</td>
														<td class="text-end">{$formShip['option_skipper']}</td>
													</tr>
												</tbody>
											</table>
										</div>
	...
	<script src="{$templateAdminPath}assets/js/main.js"></script>
